...
export function ContactSection({ showHeader = true, variant = 'blue' }: ContactSectionProps) {
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg">
            ...
            <div className="space-y-3 text-gray-700">
              <div className="flex items-center justify-between bg-[rgba(255,123,172,0.15)] rounded-2xl px-4 py-3">
                <span className="font-semibold">{content.emailLabel}</span>
                <a
                  href={`mailto:${content.emailValue}`}
                  className="text-[var(--brand-red)] font-medium"
                >
                  {content.emailValue}
                </a>
              </div>
